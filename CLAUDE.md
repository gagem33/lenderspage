...
- **Next:** source-date freshness display (#4); pick-your-columns compare (#8). Rate sheets (#3) are done for every lender whose document carries rates — see the Decisions row for 2026-08-26
